...
const translations = {
  en: {
    ...
    quote: "Language is not universal, but entertainment is. <br/> Whether it is films, tv or streaming events, we can all enjoy a good show no matter where we are from or what language we speak!",
    aboutTag: "// IDENTITY",
    aboutTitle: "About CG Translations",
    aboutText: "I'm Camila Grisel. I craft translations and subtitles that sound right — capturing the tone, emotion, and intent of your original message.",
    whyTag: "// VALUE PROPOSITION",
    whyTitle: "Why CG Translations?",
    why1: "Native-speaking translator",
    ...
    servicesData: [
      ...
      { title: "Voice-over & Dubbing Coordination", desc: "Ensuring script synchronization and technical adaptation for multimedia and video assets." },
  ...
  es: {
    ...
    quote: "El idioma no es universal, pero el entretenimiento sí. <br/> Ya sean películas, series o <i>streaming</i>, ¡todos podemos disfrutar de un buen show sin importar de dónde seamos!",
    aboutTag: "// IDENTIDAD",
    aboutTitle: "Sobre CG Translations",
    aboutText: "Soy Camila Grisel. Creo traducciones y subtítulos que suenan naturales, capturando el tono, la emoción y la intención del mensaje original.",
    whyTag: "// PROPUESTA DE VALOR",
    whyTitle: "¿Por qué CG Translations?",
    why1: "Traductor nativo",
    why2: "Fuerte conocimiento de la industria",
    why3: "Compromiso absoluto con la confidencialidad",
    ...
    servicesData: [
      { title: "Traducción y Localización", desc: "Adaptación fluida de textos para regiones de habla hispana, para mantener matices culturales, tono e intención original." },
      { title: "Subtitulado y Captioning", desc: "Subtitulado y <i>closed captions</i> sincronizado y preciso, optimizado para una lectura cómoda y un flujo cinematográfico natural." },
      ...
      { title: "Coordinación de Doblaje y Voice Over", desc: "Sincronización de guiones y adaptación técnica para contenidos multimedia." },
      ...
      { title: "Desktop Publishing (DTP)", desc: "Maquetación y ajuste de formatos y así resolver archivos originales, resolviendo la expansión de texto típica del español." }
    ],
    indTag: "// SECTORES CLAVE",
    indTitle: "Industrias que atiendo",
    ...
    ctaTitle: "¿Busca expandir su audiencia?",
          ...
          {t.servicesData.map((service, idx) => (
            <div key={idx} className="service-modern-card">
              ...
              <div className="card-body-text">
                ...
                <p className="service-description" dangerouslySetInnerHTML={{ __html: service.desc }}></p>
              </div>
            </div>
          ))}
        </div>
